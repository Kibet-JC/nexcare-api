...
export async function seedDatabase(): Promise<{
  ...
  // entities. CASCADE + correct order keeps the FK from appointments -> patients
  // happy; RESTART IDENTITY resets sequences.
  ...
  const summary = { patients: createdPatients.length, appointments: appointmentCount };
